# Generated by Django 5.1 on 2025-07-02 13:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logradouro_nome', models.CharField(blank=True, max_length=100)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('necessidade_especial_detalhe', models.CharField(blank=True, max_length=100, null=True)),
                ('local_prova', models.CharField(max_length=100)),
                ('data_prova', models.DateField()),
                ('escola_2024', models.CharField(max_length=100)),
                ('status', models.CharField(default='Inscrição recebida', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ano_exame', models.IntegerField(blank=True, null=True)),
                ...
                ('certificado_data_emissao', models.DateField(blank=True, null=True)),
                ('certificado_numero', models.CharField(blank=True, max_length=50, null=True)),
                ('atestado_emitido', models.BooleanField(default=False)),
                ('atestado_data_emissao', models.DateField(blank=True, null=True)),
                ('atestado_numero', models.CharField(blank=True, max_length=50, null=True)),
                ('email', models.EmailField(max_length=254)),
                ('data_nascimento', models.DateField(blank=True, null=True)),
                ...
                ('rg_responsavel', models.CharField(blank=True, max_length=20, null=True)),
                ('tipo_responsavel', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('data_inscricao', models.DateTimeField(auto_now_add=True)),
                ('token_recuperacao', models.UUIDField(blank=True, null=True)),
                ...
                ('deseja_participar_aulao', models.CharField(choices=[('Sim', 'Sim'), ('Não', 'Não')], default='Não', max_length=3)),
                ('turnos_aulao', models.TextField(blank=True, help_text='Turnos selecionados: Matutino, Vespertino, Noturno', null=True)),
                ('bairro', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='webapp.bairro')),
            ],
        ),
    ]
